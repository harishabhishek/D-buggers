...
?>
<FORM ACTION="editGestureBack.php" METHOD="post">
    
    <table border="3">
    <tr>
    <th><b>New Description</b></th>
    <th><b>New Details</b></th>
    </tr>
       
        <tr>
            <td><input name="gestureName" type="text" size"20"></input></td>
           <td><input name="gestureLink" type="text" size"20"></input></td>
        </tr>
